...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pytest-rerunfailures-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pytest-rerunfailures-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pytest-rerunfailures
# for installing globally
pixi global install pytest-rerunfailures
```
...
It is possible to list all of the versions of `pytest-rerunfailures` available on your platform:
...
```
pixi search pytest-rerunfailures --channel conda-forge
```
